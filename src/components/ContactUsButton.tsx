...
const ContactUsButton = ({ pastBanner }: Props) => {
  return (
    <div
      className={`fixed 4xl:bottom-12 4xl:right-28 3xl:bottom-10 3xl:right-28 2xl:bottom-8 2xl:right-28 xl:bottom-9 xl:right-24 lg:bottom-20 lg:right-8 md:bottom-7 md:right-7 bottom-6 right-6 z-30 cursor-pointer group transition-opacity duration-500 ${pastBanner ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
    >
      <div className="group">
