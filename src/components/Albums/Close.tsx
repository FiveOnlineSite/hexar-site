...
const CloseButton = ({ categorySlug, reelSlug, basePath, projectSlug }: CloseButtonProps) => {
  ...
  } else if (basePath === "showreels" && reelSlug) {
    href = `/showreels/${reelSlug}`;
  }

  return (
    <div>
      <a href={href} className="close-button h-10 w-10 absolute 3xl:top-[15%] 2xl:top-[15%] xl:top-[18%] lg:top-[20%] md:top-[20%] top-[10%] left-[5%] z-10">
