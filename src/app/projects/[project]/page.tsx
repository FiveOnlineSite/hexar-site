  ...
  return <h1>Project Not Found</h1>
    ...
    return (
          <section className="categories-banner-section mt-[100px] lg:p-16 md:p-16 p-8">
            ...
            <div className="reveal-stagger grid lg:grid-cols-6 md:grid-cols-4 grid-cols-2 mt-6 gap-2">
              {currentProject.albums && currentProject.albums.map((album) => (
                ...
                <img src={album.album_img} className="z-10 h-full w-full object-contain relative overflow-hidden" alt={`Album-${album.id}`}  />
                <div className="absolute z-20 top-0 -right-[102%] 3xl:w-[310px] 3xl:h-[310px] 2xl:w-[280px] 2xl:h-[280px] xl:h-[200px] xl:w-[200px] lg:h-[145px] lg:w-[145px] 3xl:block 2xl:block xl:block lg:block none bg-[#00000066] group-hover:right-0 duration-700 transition-all overflow-hidden"></div>
                  <h5 className="absolute z-20 3xl:-bottom-[20%] 2xl:-bottom-[20%] xl:-bottom-[28%] lg:-bottom-[25%] left-[2%] bottom-[5%] 3xl:group-hover:bottom-0 2xl:group-hover:bottom-0 xl:group-hover:bottom-0 lg:group-hover:bottom-0 duration-700 transition-all p-2 lg:text-[20px] md:text-[18px] text-[16px] leading-tight font-semibold">{album.title}</h5>
                </div>
                </Link>
              ))}
            </div>
