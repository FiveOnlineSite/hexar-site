    ...
    return (
        <section className="banner-section">
            <div className="relative h-screen w-full">
                ...
                {video ? <video src={video} loop muted autoPlay playsInline className="relative w-full h-screen object-cover"></video> : <img src={image} alt={`${title} banner background`} className="relative w-full h-screen object-cover" />}
