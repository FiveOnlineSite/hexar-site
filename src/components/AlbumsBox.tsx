      ...
      {filteredAlbums.map((album) => (
        ...
        >
          <div className="text-left relative group overflow-hidden">
            ...
            <h5 className="absolute 3xl:-bottom-[20%] 2xl:-bottom-[20%] xl:-bottom-[28%] lg:-bottom-[20%] bottom-0 left-[2%] 3xl:group-hover:bottom-0 2xl:group-hover:bottom-0 xl:group-hover:bottom-0 lg:group-hover:bottom-0 transition-all duration-700 p-2 3xl:text-[20px] 2xl:text-[18px] xl:text-[16px] lg:text-[16px] md:text-[15px] text-[14px] leading-tight font-semibold">
              {album.title}
            </h5>
          </div>
        </Link>
