    ...
    <>
      {filteredAlbums.map((album) => (
        <Link
          ...
          key={album.id} className="flex items-center justify-center"
        >
          <div className="4xl:h-[400px] 4xl:w-[400px] 3xl:h-[280px] 3xl:w-[280px] 2xl:h-[250px] 2xl:w-[250px] xl:h-[200px] xl:w-[200px] lg:h-[150px] lg:w-[150px] h-full w-full relative group overflow-hidden">
            <img
              src={album.album_img}
              className="4xl:h-[400px] 4xl:w-[400px] 3xl:h-[280px] 3xl:w-[280px] 2xl:h-[250px] 2xl:w-[250px] xl:h-[200px] xl:w-[200px] lg:h-[150px] lg:w-[150px] h-full w-full group-hover:scale-125 transition-all duration-700 object-contain"
              alt={album.title}
            />
