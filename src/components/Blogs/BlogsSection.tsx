...
setVisibleCount(BLOGS_PER_VIEW)
  ...
  return (
    <section className="section-reveal blogs-section lg:p-16 md:p-16 p-8 bg-[#0A0A0A] bg-[url('/images/blogs-bg.png')] bg-no-repeat bg-cover bg-right-bottom bg-[length:80%]">
        ...
        {BLOGS_PER_VIEW < blogs.length && (
            <div className=' flex items-center justify-center mt-8 group'>
