    ...
    return(
      ...
      <div className="relative z-10 flex items-center">
                <div className="lg:w-[65%] w-full lg:pb-16 md:pb-16 pb-8">
                    <h2 className=" 4xl:text-[70px] 3xl:text-[70px] 2xl:text-[65px] xl:text-[56px] lg:text-[56px] md:text-[48px] text-[30px] font-bold text-white lg:leading-tight md:leading-tight leading-[40px] lg:px-16 lg:pt-16 lg:pb-8 md:px-16 md:pt-16 pb-4 pt-8 px-8"><span className="text-[#D50000]">End-to-End </span>3D Art Solutions for Film, Games & Beyond</h2>
                    ...
                    <div className="-stagger grid grid-cols-1 lg:grid-cols-3 md:grid-cols-3 items-center justify-center xl:w-[85%] w-full lg:mt-[10%] lg:mb-[8%] lg:px-16 md:px-16 px-8">
